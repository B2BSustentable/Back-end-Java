...
public record RegisterRequestDTO(@NotBlank String nomeEmpresa,@NotBlank @CNPJ String cnpj, @NotBlank @Email String email, @NotBlank String senha, String descricao, LocalDateTime dataDeCriacao, String photo, String photoCapa ,@NotNull TipoPlanos tipoPlanos, int qtdNegociantes, int limiteDeProdutos, boolean consultasIlimitadas, boolean addFavoritos, List<Endereco> enderecos) {
    }