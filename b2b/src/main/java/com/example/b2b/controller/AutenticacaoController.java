...
public class AutenticacaoController {
    ...
    private TokenService tokenService;
        ...
        public ResponseEntity registrar(@RequestBody @Valid RegisterRequestDTO data) {
            ...
            Empresa empresaEntity = empresaService.cadastrarEmpresa(new RegisterRequestDTO(data.nomeEmpresa(), data.cnpj(), data.email(), senhaEncriptada, data.descricao(), LocalDateTime.now(), data.photo(), data.photoCapa() ,data.tipoPlanos(), data.qtdNegociantes(), data.limiteDeProdutos(), data.consultasIlimitadas(), data.addFavoritos(), data.enderecos()));

            RegisterResponseDTO registroResponse = new RegisterResponseDTO(empresaEntity.getNomeEmpresa(), empresaEntity.getCnpj(), empresaEntity.getDataDeCriacao(), empresaEntity.getEmail(), empresaEntity.getTipoPlanos(), empresaEntity.getDescricao(), empresaEntity.getPhoto(), empresaEntity.getPhotoCapa(), empresaEntity.getEndereco());
            RegisterResponseCompletaDTO registroResponseCompleta = new RegisterResponseCompletaDTO(empresaEntity.getUIdEmpresa(), empresaEntity.getNomeEmpresa(), empresaEntity.getCnpj(), empresaEntity.getDataDeCriacao(), empresaEntity.getEmail(), empresaEntity.getTipoPlanos(), empresaEntity.getDescricao(), empresaEntity.getPhoto(), empresaEntity.getPhotoCapa(), empresaEntity.getPlano().getQtdNegociantes(), empresaEntity.getPlano().getLimiteProdutos(), empresaEntity.getPlano().isConsultasIlimitadas(), empresaEntity.getPlano().isAddFavoritos(), empresaEntity.getEndereco());
